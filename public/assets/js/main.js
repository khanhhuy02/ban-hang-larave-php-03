(function($) {
    ...
    CartPlusMinus.prepend('<div class="dec tt qtybutton">-</div>');
    CartPlusMinus.append('<div class="inc tt qtybutton">+</div>');
    $(".qtybutton").on("click", function() {
        var $button = $(this);
        var oldValue = $button.parent().find("input").val();

        var total  =  $button.closest('.product_data').find('.total').val();
       ...
       var all =  newVal * price_new ;

       $button.closest('.product_data').find('.total').text(all);

                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4  col-md-6 col-sm-6 col-xs-6" data-aos="fade-up" data-aos-delay="200">
                                ...
                                <div class="product mb-25px">
                                    <div class="thumb">
                                        <a class='image' href='shop-left-sidebar.html'>
                                            <img src="{{asset('assets/images/product-image/13.jpg')}}" alt="Product" />
                            ...
                            <div class="col-lg-4  col-md-6 col-sm-6 col-xs-6" data-aos="fade-up" data-aos-delay="400">
                                ...
                                <div class="product mb-25px">
                                    <div class="thumb">
                                        <a class='image' href='shop-left-sidebar.html'>
                                            <img src="{{asset('assets/images/product-image/15.jpg')}}" alt="Product" />
                            ...
                            <div class="col-lg-4  col-md-6 col-sm-6 col-xs-6" data-aos="fade-up" data-aos-delay="400">
                                ...
                                <div class="product mb-25px">
                                    <div class="thumb">
                                        <a class='image' href='shop-left-sidebar.html'>
                                            <img src="{{asset('assets/images/images/product-image/5.jpg')}}" alt="Product" />
                                            <!-- <img class="hover-image" src="images/product-image/6.jpg" alt="Product" /> -->
                                        </a>
                                        <span class="badges">
                                            <span class="sale">-5%</span>
                            ...
                            <div class="col-lg-4  col-md-6 col-sm-6 col-xs-6" data-aos="fade-up" data-aos-delay="600">
                                ...
                                <div class="product mb-25px">
                                    <div class="thumb">
                                        <a class='image' href='shop-left-sidebar.html'>
                                            <img src="{{asset('assets/images/images/product-image/7.jpg')}}" alt="Product" />
                                            <!-- <img class="hover-image" src="images/product-image/8.jpg" alt="Product" /> -->
                                        </a>
                                        <span class="badges">
                                        </span>
                            ...
                            <div class="col-lg-4  col-md-6 col-sm-6 col-xs-6" data-aos="fade-up" data-aos-delay="200">
                                ...
                                <div class="product mb-25px">
                                    <div class="thumb">
                                        <a class='image' href='shop-left-sidebar.html'>
                                            <img src="{{asset('assets/images/images/product-image/9.jpg')}}" alt="Product" />
                                            <!-- <img class="hover-image" src="images/product-image/10.jpg" alt="Product" /> -->
                                        </a>
                                        <span class="badges">
                                            <span class="sale">-7%</span>
                            ...
                            <div class="col-lg-4  col-md-6 col-sm-6 col-xs-6" data-aos="fade-up" data-aos-delay="400">
                                ...
                                <div class="product mb-25px">
                                    <div class="thumb">
                                        <a class='image' href='shop-left-sidebar.html'>
                                            <img src="{{asset('assets/images/images/product-image/11.jpg')}}" alt="Product" />
                                            <!-- <img class="hover-image" src="images/product-image/12.jpg" alt="Product" /> -->
                                        </a>
                                        <span class="badges">
                                            <span class="new">New</span>
                            ...
                            <div class="col-lg-4  col-md-6 col-sm-6 col-xs-6" data-aos="fade-up" data-aos-delay="600">
                                ...
                                <div class="product mb-25px">
                                    <div class="thumb">
                                        <a class='image' href='shop-left-sidebar.html'>
                                            <img src="{{asset('assets/images/images/product-image/13.jpg')}}" alt="Product" />
                                            <!-- <img class="hover-image" src="images/product-image/14.jpg" alt="Product" /> -->
                                        </a>
                                        <span class="badges">
                                        </span>
                            ...
                            <div class="col-lg-4  col-md-6 col-sm-6 col-xs-6" data-aos="fade-up" data-aos-delay="200">
                                ...
                                <div class="product mb-25px">
                                    <div class="thumb">
                                        <a class='image' href='shop-left-sidebar.html'>
                                            <img src="{{asset('assets/images/images/product-image/15.jpg')}}" alt="Product" />
                                            <!-- <img class="hover-image" src="images/product-image/16.jpg" alt="Product" /> -->
                                        </a>
                                        <span class="badges">
                                            <span class="sale">-5%</span>
                            ...
                            <div class="col-lg-4  col-md-6 col-sm-6 col-xs-6" data-aos="fade-up" data-aos-delay="400">
                                ...
                                <div class="product mb-25px">
                                    <div class="thumb">
                                        <a class='image' href='shop-left-sidebar.html'>
                                            <img src="{{asset('assets/images/images/product-image/1.jpg')}}" alt="Product" />
                                            <!-- <img class="hover-image" src="images/product-image/2.jpg" alt="Product" /> -->
                                        </a>
                                        <span class="badges">
                                        <span class="new">New</span>
                            ...
                            <div class="col-lg-4  col-md-6 col-sm-6 col-xs-6" data-aos="fade-up" data-aos-delay="600">
                                ...
                                <div class="product mb-25px">
                                    <div class="thumb">
                                        <a class='image' href='shop-left-sidebar.html'>
                                            <img src="{{asset('assets/images/images/product-image/3.jpg')}}" alt="Product" />
                                            <!-- <img class="hover-image" src="images/product-image/4.jpg" alt="Product" /> -->
                                        </a>
                                        <span class="badges">
                                            <span class="sale">-5%</span>
